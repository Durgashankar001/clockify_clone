...
const Download = () => {
    return (
        <div>
            ...
            >
                ...
                >
                    <Heading
                        fontWeight={"400"}
                        size={["lg", "2xl"]}
                        color={"gray.600"} pt="2" pb="8">
                        Time tracking apps
                    </Heading>
                </Box>
                <Text fontWeight={400} style={{ letterSpacing: "1px" }} color={"gray.600"} fontSize={"lg"}>
                    Install Clockify and track time from anywhere — everything is synced online.
                </Text>

                <Box>
                    <Box pt="3" pb="3">
                        <Box display={"flex"} justifyContent={"center"} gap={["2", "3", "5"]} p={"2"} flexWrap={"wrap"} >
                            {DownloadAppStore?.map((el) => (
                                <UnorderedList key={el}>
                                    <ListItem className='download_list' color={"#03a9f4"} fontWeight={"600"} fontSize={["1rem", "1.1rem", "1.2rem"]} cursor={"pointer"} _hover={{ textDecoration: "underline" }}>
                    ...
                    <VStack justifyContent="center">
                        ...
                        {imgeSection?.map(
                            ({ name, img, innerText, groupLogo, tag, button }, index, el) => (
                                <Box key={index} w={["20rem", "45rem", "53rem"]}>
                                    ...
                                    >
                                        <Box display="flex" margin="auto" justifyContent="center">
                                            <Image src={img} className={"download_img"} mr={"1rem"} />
                                        </Box>
                                        <Box className={"download_box"}>
                                            <Box>
                                                ...
                                                {button ? (
                                                    <Text className='download_text' color={"blue"} fontSize={"1xl"}>
                                                        Lern more
                                                    </Text>
                                                ) : null}
                                            </Box>
            ...
            <div style={{background:"linear-gradient(#e8f5fd,#ffff)",padding:"4rem"}}>
                <Heading
                    mt={20}
                    mb={2}
                    textAlign={"center"}
